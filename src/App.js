...
class App extends React.Component{
  constructor(props){
    super(props)
    this.state={location:"",loader:false,displayLocation:"",weather:{}}
  ...
  render(){
   return( <div className="app">
      ...
      <div>
        <input type="text" value={this.state.location} onChange={(e)=>this.setState({location:e.target.value})} placeholder="Search from location..."/>
      </div>
